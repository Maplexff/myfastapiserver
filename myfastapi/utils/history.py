...
class History():
    ...
    def after_epoch(self, meta):
        ...
        val_acc_epoch = []
        train_acc_epoch = []
        epoch_outputs = [['index', 'train_loss', 'train_acc', 'train_precision', 'train_recall', 'train_f1-score', 'val_loss', 'val_acc', 'val_precision', 'val_recall', 'val_f1-score']]#,'val_acc0','val_acc1','val_acc2','val_acc3','val_acc4','val_acca'
